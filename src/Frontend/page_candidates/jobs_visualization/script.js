...
// Consumo de api por jQuery com o método get
    $.get("http://localhost:3000/jobs", function(resultado){
          ...
          <div class="row">
           <div class="mt-3 text-center col-12">
            ...
            <!--Conteúdo Card-->
             ...
             <div class="col-12">
              <div class="col-12" style="text-align: left;"><p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-briefcase-fill" viewBox="0 0 16 16">
        ...
        <div class="col-12">&nbsp;</div>
             <button class="btn btn-primary btn-sm follow" data-bs-toggle="modal" data-bs-target="#modalid` + resul.id + `" style="background-color: purple;">Saber Mais</button>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body row" style="text-align: left;">
                      ...
                      <ul style="list-style-type: none; text-align: justify;"><li style="font-size: 0.9rem;">` + resul.company_description + `</li></ul>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Recusar</button>
                      <button type="button" class="btn btn-primary" style="background-color: purple;">Contactar</button>
                    </div>
                  </div>
                </div>
              </div>
