...
var companyDescription = document.getElementById('registrationJobs-description-bonus');
...
iconConfirm.addEventListener('click', function (e) {
	e.preventDefault();
	informationJob = {
		job_name: jobsName.value,
		type: jobsType.value,
		time: jobsTime.value === 'full-time' ? 6 : 4,
		salary: jobsSalary.value,
		modality: jobsModality.value,
		shift: jobsShift.value,
		number: jobsNumber.value,
		postal_code: jobsCP.value,
		proficiency: jobsProficiency.value,
		name_company: jobsNameCompany.value,
		job_description: jobsDescription.value,
		description: companyDescription.value,
		email: jobsEmail.value,
...
function postarCadastro() {
	$.post('http://127.0.0.1:3000/api/jobs/old', informationJob, function (response) {
