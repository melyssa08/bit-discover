...
function teste() {
        ...
        <div class="col-12">&nbsp;</div>
          <div id='jobsVisualization-space-like'>
             <button class="btn btn-primary btn-sm follow" id="jobsVisualization-follow" data-bs-toggle="modal" data-bs-target="#modalid` +
				resul.id +
				`">SAIBA MAIS</button>
             <svg xmlns="http://www.w3.org/2000/svg" width="35" height="30" id="jobsVisualization-icon-like` +
				resul.id +
              ...
              <!---->
				...
				`</li>
                      ...
                      <ul class="jobsVisualization-activities-required">
                        <li>` +
				[...resul.requireds_hardskill, resul.requireds_softskill].join(', ') +
				`</li>
                      </ul>
	...
	resultado.forEach((resul) => {
		var iconLike = document.getElementById(`jobsVisualization-icon-like${resul.id}`);
